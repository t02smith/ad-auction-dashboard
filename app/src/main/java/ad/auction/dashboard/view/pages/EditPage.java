...
public class EditPage extends BasePage{
    ...
    public Campaign.CampaignData oldCampaign;
    ...
    public EditPage(Window window, String name) {
        super(window);
        campaignName = name;
        oldCampaign = (Campaign.CampaignData) controller.query(ControllerQuery.GET_CAMPAIGN_DATA,campaignName).get();
    }
    ...
    public void build() {
        ...
        saveButton.setOnAction(event -> {
            // TODO update information and return to page
        });
        ...
        deleteButton.setOnAction(event -> {
            // TODO removes the campaign from campaigns list and returns to main page
        });
